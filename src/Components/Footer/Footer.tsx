    ...
    <div className="Footer">
        <div className="Footer-section">
            ...
            <div className="section-2">
                <h4 className="heading">Useful Link</h4>
                <h5 className="heading-2"><a href="#">&gt; Website and Apps</a></h5>
                <h5 className="heading-2"><a href="#">&gt; Digital Marketing and Strategy</a></h5>
                <h5 className="heading-2"><a href="#">&gt; Consulting go to Market</a></h5>
                <h5 className="heading-2"><a href="#">&gt; Creative and Design</a></h5>
                <h5 className="heading-2"><a href="#">&gt; Business Planning</a></h5>
                <h5 className="heading-2"><a href="#">&gt; Privacy Policy</a></h5>
                <h5 className="heading-2"><a href="#">&gt; Join as Solution Partner</a></h5>
            </div>
            <div className="section-3">
                <h4 className="heading">For Enquiries</h4>
                <p>Info@wansaa.in</p>
                <p>Contactus@wansaa.in</p>
                <p><strong>Call us at : </strong> +91 7006184231</p>
                <h4 className="heading">Join as Solution Partner</h4>
            ...
            <div className="section-4">
                <h4 className="heading">Our Offices</h4>
